...
(
    ...
    create_time          datetime                     NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    account_balance      NUMERIC(14, 4)               NOT NULL DEFAULT 0.0000 COMMENT '账户余额',
...
(
    ...
    change_before_amount NUMERIC(14, 4)               NOT NULL  COMMENT '变动前余额',
    change_after_amount  NUMERIC(14, 4)               NOT NULL COMMENT '变动后余额',
